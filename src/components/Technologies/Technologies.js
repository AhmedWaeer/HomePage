 ...
 <Section id="tech">
    ...
    <SectionText>
      <ul >
        ...
        <li className="list-disc p-2">Learning the<span className="text-white font-bold bg-blue-800 rounded-md mx-2 my-2"> JAMstack </span>  architecture/philosophy using React frameworks such as<span className="text-white font-bold bg-blue-800rounded-md">  GatsbyJS </span>and <span className="text-white font-bold bg-blue-800 rounded-md mx-2 my-2">  NextJS </span> and deploying to CDNs like<span className="text-white font-bold bg-blue-800 rounded-md mx-2 my-2">  Netlify</span>.</li>
