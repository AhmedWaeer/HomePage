 ...
 <Section id="tech">
    ...
    <SectionText>
      <ul className="" >
        ...
        <li className="list-disc">Learning the<span className="text-white font-bold bg-blue-800 rounded-md"> JAMstack </span>  architecture/philosophy using React frameworks such as<span className="text-white font-bold bg-blue-800rounded-md">  GatsbyJS </span>and <span className="text-white font-bold bg-blue-800 rounded-md">  NextJS </span> and deploying to CDNs like<span className="text-white font-bold bg-blue-800 rounded-md">  Netlify</span>.</li>
